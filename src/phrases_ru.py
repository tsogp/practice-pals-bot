...
we_ask_personal_data = "Для лучшей работы бота Вы можете ввести свои персональные данные (имя, фамилию и возраст).\n\nОни не передаются третьим лицам и используются только внутри самого бота.\n\nСоглашаетесь ли Вы на их обработку? (при желинии каждый из критерив можно будет не указывать отдельно)"

agree = "Согласиться"
refuse = "Отказаться"

personal_data_you_agree = "Вы согласились на обработку персональных данных"
personal_data_you_refuse = "Вы не согласились на обработку персональных данных"
