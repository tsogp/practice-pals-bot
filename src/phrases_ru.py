...
edit_profile_menu = "Вы находитесь в меню редактирования профиля"

select_the_profile_item_to_edit = "Выберите поле профиля, которое Вы хотите отредактировать"

edit_search_parameters_menu = "Вы находитесь в меню редактирования параметров поиска"

select_the_search_parameters_item_to_edit = "Выберите параметр поиска, который Вы хотите отредактировать"
