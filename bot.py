        ...
        if users_menu_id == constants.MenuIds.REGISTRATION_MENU:
            if users_registration_item_id == constants.RegistationItemsIds.FIRST_NAME:
                if users_message == phrases.do_not_specify:
                    Bot.__database.write_empty_users_registration_item(telegram_id=message.chat.id,
                                                                       item=constants.RegistationItemsIds.FIRST_NAME)
                else:
                    Bot.__database.write_users_registration_item(telegram_id=message.chat.id,
                                                                 item=constants.RegistationItemsIds.FIRST_NAME,
                                                                 value=users_message)

                Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                Bot.__bot.send_message(message.chat.id, text=phrases.enter_your_last_name)
                ...
                Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                Bot.__bot.send_message(message.chat.id, text=phrases.enter_your_age)
                ...
                Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                Bot.__bot.send_message(message.chat.id, text=phrases.enter_your_spoken_languages,
                ...
                if users_message in (phrases.do_not_specify, phrases.finish_typing):
                    Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                    Bot.__bot.send_message(message.chat.id, text=phrases.enter_your_programming_languages,
                ...
                if users_message in (phrases.do_not_specify, phrases.finish_typing):
                    Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                    Bot.__bot.send_message(message.chat.id, text=phrases.enter_your_interests,
                ...
                if users_message in (phrases.do_not_specify, phrases.finish_typing):
                    Bot.__database.switch_user_to_next_registration_item(telegram_id=message.chat.id)
                    Bot.__bot.send_message(message.chat.id, text=phrases.finish_registration,
                                           reply_markup=telebot.types.ReplyKeyboardRemove())
