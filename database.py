class Database:
    ...
    def set_users_menu_id(self, user_id: int, new_menu_id: int):
    ...
    def set_users_registration_item(self, user_id: int, item: int, value: str):
        self.__data[item] = value

    def get_users_profile_item(self, user_id: int, item: int):
        return self.__data[item]

    def append_to_users_registration_item(self, user_id: int, item: int, value: str):
